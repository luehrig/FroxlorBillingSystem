<div class='mainmenu'>
	<ul>
	   <li class='active '><a href='#!page=home' id="home" class="nav"><span><?php echo VIEW_MENU_HOME; ?></span></a></li>
	   <li><a href='#!page=products' id="products" class="nav"><span><?php echo VIEW_MENU_PRODUCTS; ?></span></a></li>
