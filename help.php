...
<div class="colorboxwrapper">
	<div class="contact">
		<form method="post" action="#" class="contact_message" accept-charset=utf-8>
			...
			echo'</p>
				<p>
		    		<input type="radio" class="message_type" name="message_type" id="question" value="Frage" checked>Frage
		    		<input type="radio" class="message_type" name="message_type" id="problem" value="Probleme">Probleme
		    		<input type="radio" class="message_type" name="message_type" id="feedback" value="Feedback">Feedback
		  		</p>
		  		<p>
