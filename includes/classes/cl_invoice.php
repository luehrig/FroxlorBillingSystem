...
class invoice {
	...
	public static function printOverviewBackend($container_id = 'invoice_overview') {
		...
		while($data = db_fetch_array($invoice_query)) {
			...
			<td><a href="../display_invoice.php?invoice_id='. $invoice->getInvoiceID() .'" id="display_invoice" target="_blank"><img src="'. PATH_IMAGES_REL .'show.png" title="'. LINK_DISPLAY . '"></a></td>
			<td><a href="#!change_invoice_invoice" rel="'. $invoice->getInvoiceID() .'" id="change_invoice_status"><img src="'. PATH_IMAGES_REL .'activate.png" title="'. LINK_SAVE_INVOICE_STATUS . '"></a></td>
			</tr>';
		}
