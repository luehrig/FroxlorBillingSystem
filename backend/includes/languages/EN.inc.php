...
define('PAGE_TITLE_SHOPPINGCART','Basket');
...
define('FIELDSET_ADDRESS_INFORMATION','Shipping Address');
...
define('FIELDSET_CUSTOMER_SHIPPING_ADDRESS_INFORMATION','Shipping Address');
